    ...
    public function sendOnboarding(CandidateVacancy $candidateVacancy): void
    {
        ...
        $this->sendOnce(
            ...
            $this->renderEmail(
                ...
                sprintf(
                    "Olá %s,\n\nEstá tudo pronto para começares a tua jornada na INNER Studios! Bem-vindo à equipa!\n\nPara garantirmos que tens tudo o que precisas para o teu primeiro dia, criámos o teu fluxo de onboarding. Pedimos que completes os seguintes passos:\n\n**Passos obrigatórios:**\n1. **Aceder às Comunidades:** Junta-te ao nosso Teams corporativo e ao servidor oficial de Discord através dos links disponibilizados abaixo.\n2. **Indicar Disponibilidade:** Acede ao portal e indica as tuas disponibilidades de horários para a tua primeira reunião de alinhamento com o teu team manager.\n\nEstamos muito felizes por te ter a bordo!",
                    $candidate->getFirstName()
                ),
                'Iniciar Onboarding',
                $url,
